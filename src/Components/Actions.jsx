  ...
  return (
    <div className="flex justify-between items-center gap-6">
      <div className="relative">
        ...
        <span className="absolute -right-3 -top-3 rounded-full w-5 h-5 flex justify-center items-center text-xs font-semibold text-green-700 bg-[#dafcf1]">{posts.length}</span>
      </div>
